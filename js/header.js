...
class GlobalHeader extends HTMLElement {
    connectedCallback() {
        ...
        <header class="global-header">
            ...
            <div class="header-right">
                ...
                <button id="${sidebarToggle ? 'mobile-nav-toggle' : 'mobile-menu-toggle'}" 
                        class="${sidebarToggle ? 'mobile-nav-toggle' : 'mobile-menu-toggle'}" 
    ...
    initControls() {
        ...
        // ---- Mobile Nav Menu Dropdown & Sidebar Toggle Animations ----
        // Target whichever menu button is currently rendered on the page
        const mobileMenuToggle = this.querySelector('#mobile-menu-toggle') || this.querySelector('#mobile-nav-toggle');
        ...
        if (mobileMenuToggle) {
            ...
            mobileMenuToggle.addEventListener('click', () => {
                // If a standard nav menu dropdown exists, toggle its visibility
                if (mobileNavMenu) {
                    ...
                    // For the API sidebar, toggle the state attribute directly on the button
                    const isExpanded = mobileMenuToggle.getAttribute('aria-expanded') === 'true';
                    mobileMenuToggle.setAttribute('aria-expanded', !isExpanded);
                }

                // Smoothly cycle the icon states from hamburger to X
                const currentlyExpanded = mobileMenuToggle.getAttribute('aria-expanded') === 'true';
        ...
        // Close dropdown menu if viewport is resized to desktop width
